...
public class Calculator {
	...
	private JButton NewButtonDivide;
	...
	private void initialize() {
		...
		NewButtonDivide = new JButton("/");
		NewButtonDivide.setForeground(Color.DARK_GRAY);
		NewButtonDivide.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		NewButtonDivide.setFont(new Font("Times New Roman", Font.BOLD, 20));
		NewButtonDivide.setBounds(176, 139, 109, 33);
		frame.getContentPane().add(NewButtonDivide);
